module.exports = {
	...
	async execute(message, args, bot) {
		...
		const uniqueBeans = bot.userInfo.get(`${message.guild.id}-${message.author.id}`, "inventory.uniqueBeans");
		...
		if (!uniqueBeans.includes(flavour)) {
			bot.userInfo.push(`${message.guild.id}-${message.author.id}`, flavour, "inventory.uniqueBeans");
		}
